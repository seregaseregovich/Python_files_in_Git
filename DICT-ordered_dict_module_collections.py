# СПОСОБ 1.
# =========================================================
# Необходимо подсчитать количество одинаковых
# элементов списка и оформить результат в словарь.
# Необходимо отсортировать словарь по ключу или по значению.
...
# СПОСОБ 3.
# =========================================================
# Сортировка при помощи модуля operator
# (работает быстрее, чем обычные методы).
...
lst = sorted(users, key=operator.itemgetter('salary', 'age'))
for i in lst:
    print(i)
print()

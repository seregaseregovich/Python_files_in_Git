...
# to generate the next. And, worse part of it, regrettably I won't
# get to hear non-native Italian speakers trying to pronounce it.
#
...
# get the same sequence shifted by 2 places, but that is not
...
# returns the first n elements - signature included of
...
# awesome classes that I really recommend to any math enthusiast
# and for showing me this mathematical curiosity too with
# his usual contagious passion.


# My solution:
# ===================================.

def tribonacci_1(sig, n):
    if n == 0:
        return []
    if n == 1:
        return sig[0:1]
